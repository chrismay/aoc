export const testRules = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const part2TestRule = `shiny gold bags contain 2 dark red bags.
...
export const rules = `dotted salmon bags contain 2 dark lavender bags, 1 muted red bag, 1 vibrant magenta bag.
